...
class Settings(BaseSettings):
    ...
    system_instruction: str = Field(
        default=(
            ...
            "4. REVIEWS: Use the `submit_review` tool **ONLY AFTER** you've been able to **FULLY EVALUATE** how well the user knows a card. Grades: `correct` (easy recall), `struggled` (needed multiple hints/turns), `incorrect` (had to give up or say \"I don't know\" for ANY of the items in the card).\n"
            ...
            "5. HANDLING 'I DONT KNOW': If the user simply gives up and says 'I don't know' or 'I'm not sure' (referring to the answer), mark the card INCORRECT. However, if they say 'I'm not sure what you mean' or 'rephrase that', you should try to explain/hint instead of penalizing them.\n"
            "6. QUEUE MANAGEMENT: Check `check_top_5_cards_current_topic` frequently. If you see cards you've already discussed, you forgot to grade them! Grade them immediately.\n"
